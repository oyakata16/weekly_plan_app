...
# - バックアップ / 区教委提出CSV
# ※V5.4修正:
#   1. 復元系（下書き/自動保存/前回の続き/前週コピー）が表に確実反映
#   2. widget state に直接値を入れる apply_timetable_to_widget_state() を追加
#   3. restore_plan と画面入力のズレを解消
#   4. 自動保存後も restore_plan を更新して状態を安定化
